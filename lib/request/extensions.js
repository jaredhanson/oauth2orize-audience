...
module.exports = function() {
  ...
  function request(req) {
    ...
    //
    //     Use of this parameter is mandated by [Message Authentication Code (MAC) Tokens](https://tools.ietf.org/html/draft-ietf-oauth-v2-http-mac-05).
    //
    ...
    //     Defines usage of an `aud` parameter for the token endpoint.  The
    //     parameter's value is a single URI.  There is a discussion note
    //     positing that the parameter could carray an array of values.
    //
